...
const ZH_HANT_MESSAGES = {
  ...
  'options.officialHelp':
    '可從建議清單選擇，也可手動輸入 BCP-47 語言代碼。這是全局偏好；實際可用性仍由播放中的當前節目決定。儲存後請刷新播放頁，也可在播放器內用「語言」按鈕選擇當前節目提供的語言。',
  'options.topSubtitle': '上方字幕',
  'options.bottomSubtitle': '下方字幕',
  'options.customLanguagePlaceholder': '例如：is、uk、yue-Hant',
  'options.savePair': '儲存字幕語言',
  'options.resetPair': '恢復英文在上、繁體中文在下',
  'options.provider': '供應商',
  'options.qwenChina': '千問（阿里雲百煉·中國區）',
  'options.qwenSingapore': '千問（阿里雲百煉·新加坡區）',
  'options.doubaoChina': '豆包（火山方舟·中國區）',
  'options.openAiCompatible': 'OpenAI 兼容',
  'options.localOpenAiCompatible': '本地 OpenAI 兼容',
  'options.workspaceId': '百煉 Workspace ID',
  'options.workspaceHelp':
    '只需填寫 ws-…；DuetSub 會按所選地域自動建立 Responses API 位址。',
  'options.webSearch': '允許千問按需聯網搜尋',
  'options.webSearchHelp':
    '使用 Responses API 的 web_search 工具，推理保持完全關閉；模型自行決定是否搜尋，可能增加延遲與費用，預設關閉。',
  'options.baseUrl': 'Base URL',
  'options.apiKey': 'API key',
  'options.model': '模型',
  'options.modelOptional': '模型（可選或手動輸入）',
  ...
  'options.pairSaved': '官方字幕語言已儲存',
  'options.invalidPair': '請選擇兩種不同且有效的字幕語言',
  'options.otherLanguage': '其他語言…',
  ...
  'toggle.language': '語言',
  'toggle.languageTitle': '選擇字幕語言',
  'toggle.languageAria': '選擇 DuetSub 字幕語言',
  'toggle.top': '上方字幕',
  'toggle.bottom': '下方字幕',
  'toggle.swap': '交換上下',
  'toggle.reloadOfficial': '重新載入官方字幕',
  'toggle.retranslate': '用 AI 重譯下方字幕',
  ...
  'status.noRetranslate': '目前無法以上方字幕重譯下方字幕',
  'status.retranslating': '正在用 AI 重譯下方字幕…',
  ...
  'status.acquiringTopForAi': '正在取得 AI 重譯所需的上方官方字幕…',
  'status.topReadyForAi': '上方官方字幕已就緒 · 可用 AI 重譯下方字幕',
  'status.pairReady': '{pair} · 100%',
  'status.pairAligned': '{pair} 對齊 · 100%',
  'status.disabledReloadCleared': '關閉 · 已清除本輪官方字幕',
  'status.reloadingPair': '正在重新載入 {pair}…',
...
const ZH_HANS_MESSAGES: Record<UiMessageKey, string> = {
  ...
  'options.officialHelp':
    '可从建议列表选择，也可手动输入 BCP-47 语言代码。这是全局偏好；实际可用性仍由播放中的当前节目决定。保存后请刷新播放页，也可在播放器内用“语言”按钮选择当前节目提供的语言。',
  'options.topSubtitle': '上方字幕',
  'options.bottomSubtitle': '下方字幕',
  'options.customLanguagePlaceholder': '例如：is、uk、yue-Hant',
  'options.savePair': '保存字幕语言',
  'options.resetPair': '恢复英文在上、繁体中文在下',
  'options.provider': '供应商',
  'options.qwenChina': '千问（阿里云百炼·中国区）',
  'options.qwenSingapore': '千问（阿里云百炼·新加坡区）',
  'options.doubaoChina': '豆包（火山方舟·中国区）',
  'options.openAiCompatible': 'OpenAI 兼容',
  'options.localOpenAiCompatible': '本地 OpenAI 兼容',
  'options.workspaceId': '百炼 Workspace ID',
  'options.workspaceHelp':
    '只需填写 ws-…；DuetSub 会按所选地域自动建立 Responses API 地址。',
  'options.webSearch': '允许千问按需联网搜索',
  'options.webSearchHelp':
    '使用 Responses API 的 web_search 工具，推理保持完全关闭；模型自行决定是否搜索，可能增加延迟与费用，默认关闭。',
  'options.baseUrl': 'Base URL',
  'options.apiKey': 'API key',
  'options.model': '模型',
  'options.modelOptional': '模型（可选或手动输入）',
  'options.fallbackTarget':
  ...
  'options.pairSaved': '官方字幕语言已保存',
  'options.invalidPair': '请选择两种不同且有效的字幕语言',
  'options.otherLanguage': '其他语言…',
  'options.pair': '{topName}（{topCode}）在上，{bottomName}（{bottomCode}）在下{suffix}',
  ...
  'toggle.language': '语言',
  'toggle.languageTitle': '选择字幕语言',
  'toggle.languageAria': '选择 DuetSub 字幕语言',
  'toggle.top': '上方字幕',
  'toggle.bottom': '下方字幕',
  'toggle.swap': '交换上下',
  'toggle.reloadOfficial': '重新加载官方字幕',
  'toggle.retranslate': '用 AI 重译下方字幕',
  ...
  'status.noRetranslate': '当前无法以上方字幕重译下方字幕',
  'status.retranslating': '正在用 AI 重译下方字幕…',
  ...
  'status.acquiringTopForAi': '正在获取 AI 重译所需的上方官方字幕…',
  'status.topReadyForAi': '上方官方字幕已就绪 · 可用 AI 重译下方字幕',
  'status.pairReady': '{pair} · 100%',
  'status.pairAligned': '{pair} 对齐 · 100%',
  'status.disabledReloadCleared': '关闭 · 已清除本轮官方字幕',
  'status.reloadingPair': '正在重新加载 {pair}…',
...
const EN_MESSAGES: Record<UiMessageKey, string> = {
  ...
  'options.officialHelp':
    'Choose from the suggestions or enter a BCP-47 language tag. This is a global preference; availability still depends on the current title. Refresh the player after saving, or use its Language button to choose from the current title.',
  'options.topSubtitle': 'Top subtitle',
  'options.bottomSubtitle': 'Bottom subtitle',
  'options.customLanguagePlaceholder': 'For example: is, uk, yue-Hant',
  'options.savePair': 'Save subtitle languages',
  'options.resetPair':
    'Restore English on top and Traditional Chinese on bottom',
  'options.provider': 'Provider',
  'options.qwenChina': 'Qwen (Alibaba Cloud Model Studio · China)',
  'options.qwenSingapore':
    'Qwen (Alibaba Cloud Model Studio · Singapore)',
  'options.doubaoChina': 'Doubao (Volcengine Ark · China)',
  'options.openAiCompatible': 'OpenAI-compatible',
  'options.localOpenAiCompatible': 'Local OpenAI-compatible',
  'options.workspaceId': 'Model Studio Workspace ID',
  'options.workspaceHelp':
    'Enter only ws-…; DuetSub builds the Responses API URL for the selected region.',
  'options.webSearch': 'Allow Qwen to search the web when needed',
  'options.webSearchHelp':
    'Uses the Responses API web_search tool while keeping reasoning fully disabled. The model decides whether to search; this may add latency and cost. Off by default.',
  'options.baseUrl': 'Base URL',
  'options.apiKey': 'API key',
  'options.model': 'Model',
  'options.modelOptional': 'Model (choose or enter manually)',
  'options.fallbackTarget':
  ...
  'options.pairSaved': 'Official subtitle languages saved',
  'options.invalidPair':
    'Choose two different, valid subtitle languages',
  'options.otherLanguage': 'Other language…',
  ...
  'toggle.languageTitle': 'Choose subtitle languages',
  'toggle.languageAria': 'Choose DuetSub subtitle languages',
  'toggle.top': 'Top subtitle',
  'toggle.bottom': 'Bottom subtitle',
  'toggle.swap': 'Swap top and bottom',
  'toggle.reloadOfficial': 'Reload official subtitles',
  'toggle.retranslate': 'Use AI to retranslate bottom subtitles',
  ...
  'status.noRetranslate':
    'The bottom subtitles cannot be retranslated from the top subtitles',
  'status.retranslating': 'Using AI to retranslate bottom subtitles…',
  ...
  'status.acquiringTopForAi':
    'Getting the official top subtitles for AI retranslation…',
  'status.topReadyForAi':
    'Official top subtitles ready · use AI to retranslate the bottom',
  'status.pairReady': '{pair} · 100%',
  'status.pairAligned': '{pair} aligned · 100%',
  'status.disabledReloadCleared':
    'Off · cleared official subtitles for this attempt',
  'status.reloadingPair': 'Reloading {pair}…',
