...
const ZH_HANT_MESSAGES = {
  ...
  'toggle.language': '選項',
  'toggle.languageTitle': '字幕選項',
  'toggle.languageAria': '打開 DuetSub 字幕選項',
  'toggle.top': '上方字幕',
  'toggle.bottom': '下方字幕',
  'toggle.swap': '交換上下',
...
const ZH_HANS_MESSAGES: Record<UiMessageKey, string> = {
  ...
  'toggle.language': '选项',
  'toggle.languageTitle': '字幕选项',
  'toggle.languageAria': '打开 DuetSub 字幕选项',
  'toggle.top': '上方字幕',
  'toggle.bottom': '下方字幕',
  'toggle.swap': '交换上下',
...
const EN_MESSAGES: Record<UiMessageKey, string> = {
  ...
  'toggle.languageTitle': 'Subtitle options',
  'toggle.languageAria': 'Open DuetSub subtitle options',
